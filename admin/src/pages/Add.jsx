...
const [category,setCategory]=useState("Twopiece");
...
console.log("SubCategory: ", subCategory);
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        <div>
          ...
          <select onChange={(e)=>setCategory(e.target.value)}  className="w-full px-3 py-2">
            ...
            <option value="Doublebr">Double Breasted</option>
  ...
  <select 
    value={subCategory} // Ensure the selected value reflects the state
    onChange={(e) => {
      setSubCategory(e.target.value);
      console.log("SubCategory Selected:", e.target.value); // Debugging
    }} 
